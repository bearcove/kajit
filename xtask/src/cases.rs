...
pub(crate) fn render_bench_file() -> String {
                        ...
                        match kajit::alt_asm::load_alt_decoder(group, "postcard", &registry) {
                            Some(alt_decoder) => {
                                ...
                                let alt_preflight_result = catch_unwind(AssertUnwindSafe(|| {
                                    let func: unsafe extern "C" fn(*mut u8, &mut kajit::context::DeserContext) = unsafe { std::mem::transmute(alt_decoder.func_ptr()) };
    ...
    format!(
        "// @generated by xtask gen. Do not edit manually.\n#![allow(clippy::approx_constant)]\n{}",
...
pub(crate) fn render_test_file() -> String {
    ...
    let file_tokens = quote! {
        ...
        fn maybe_minimize_case_cfg_mir(_input: &[u8]) -> bool {
            ...
            for<'input> T: Facet<'input> + serde::Serialize + serde::de::DeserializeOwned + PartialEq + std::fmt::Debug,
        {
            ...
            if maybe_minimize_case_cfg_mir(&encoded) {
                return;
            }
            ...
            for<'input> T: Facet<'input> + PartialEq + std::fmt::Debug,
        {
            ...
            if maybe_minimize_case_cfg_mir(input) {
                return;
            }
            maybe_wait_for_debugger();
            let decoder = kajit::compile_decoder(T::SHAPE, kajit::DecoderKind::Postcard);
