...
fn render_test_file() -> String {
    ...
    out.push_str("fn assert_ir_ra_snapshots<T>(\n");
    out.push_str("    case: &str,\n");
    out.push_str("    format_label: &str,\n");
    out.push_str("    decoder: &dyn kajit::format::IrDecoder,\n");
    out.push_str("    _marker: &T,\n");
    out.push_str(")\n");
    out.push_str("where\n");
    out.push_str("    for<'input> T: Facet<'input>,\n");
    out.push_str("{\n");
    out.push_str("    let shape = T::SHAPE;\n");
    ...
    for case in &cases {
        ...
        write!(
            out,
            "#[test]\nfn generated_postcard_{}() {{\n    let value = {};\n    assert_ir_ra_snapshots(\"{}\", \"postcard\", &kajit::postcard::KajitPostcard, &value);\n    assert_postcard_case(value, true);\n}}\n\n",
            case.name,
            case.value,
            case.name
        )
