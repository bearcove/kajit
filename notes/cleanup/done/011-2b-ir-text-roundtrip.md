# 011-2b: IR text round-trip broken for data_args
...
text representation. May also need updates to `kajit-ir-text/src/ir_print.rs`
(or wherever IR is serialized to text).
