...
mod rvsdg_json {
    ...
    fn flat_struct() {
        ...
        assert_codegen_rvsdg_snapshot("json", "flat_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn nested_struct() {
        let value = Person {
        ...
        assert_codegen_rvsdg_snapshot("json", "nested_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn deep_struct() {
        let value = Outer {
        ...
        assert_codegen_rvsdg_snapshot("json", "deep_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn all_integers() {
        let value = AllIntegers {
        ...
        assert_codegen_rvsdg_snapshot("json", "all_integers", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn all_scalars() {
        let value = AllScalars {
        ...
        assert_codegen_rvsdg_snapshot("json", "all_scalars", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn bool_true_false() {
        let value = Bools { a: true, b: false };
        assert_codegen_rvsdg_snapshot("json", "bool_true_false", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn integer_boundaries() {
        let value = Boundaries {
    ...
    fn scalar_u16_v0() {
        let value = 0u16;
        assert_codegen_rvsdg_snapshot("json", "scalar_u16__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v1() {
        let value = 1u16;
        assert_codegen_rvsdg_snapshot("json", "scalar_u16__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v2() {
        let value = 127u16;
        assert_codegen_rvsdg_snapshot("json", "scalar_u16__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v3() {
        let value = 128u16;
        assert_codegen_rvsdg_snapshot("json", "scalar_u16__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v4() {
        let value = 255u16;
        assert_codegen_rvsdg_snapshot("json", "scalar_u16__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v5() {
        let value = 16383u16;
        assert_codegen_rvsdg_snapshot("json", "scalar_u16__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v6() {
        let value = 16384u16;
        assert_codegen_rvsdg_snapshot("json", "scalar_u16__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v7() {
        let value = u16::MAX;
        assert_codegen_rvsdg_snapshot("json", "scalar_u16__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v0() {
        let value = 0u32;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v1() {
        let value = 1u32;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v2() {
        let value = 127u32;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v3() {
        let value = 128u32;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v4() {
        let value = 16383u32;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v5() {
        let value = 16384u32;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v6() {
        let value = (1u32 << 21) - 1;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v7() {
        let value = 1u32 << 21;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v8() {
        let value = u32::MAX;
        assert_codegen_rvsdg_snapshot("json", "scalar_u32__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v0() {
        let value = 0u64;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v1() {
        let value = 1u64;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v2() {
        let value = 127u64;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v3() {
        let value = 128u64;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v4() {
        let value = 16383u64;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v5() {
        let value = 16384u64;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v6() {
        let value = (1u64 << 21) - 1;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v7() {
        let value = 1u64 << 21;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v8() {
        let value = u64::MAX;
        assert_codegen_rvsdg_snapshot("json", "scalar_u64__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v0() {
        let value = i16::MIN;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v1() {
        let value = -16384i16;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v2() {
        let value = -129i16;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v3() {
        let value = -128i16;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v4() {
        let value = -1i16;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v5() {
        let value = 0i16;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v6() {
        let value = 1i16;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v7() {
        let value = 127i16;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v8() {
        let value = 128i16;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v9() {
        let value = i16::MAX;
        assert_codegen_rvsdg_snapshot("json", "scalar_i16__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v0() {
        let value = i32::MIN;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v1() {
        let value = -1_000_000i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v2() {
        let value = -16384i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v3() {
        let value = -129i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v4() {
        let value = -128i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v5() {
        let value = -1i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v6() {
        let value = 0i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v7() {
        let value = 1i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v8() {
        let value = 127i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v9() {
        let value = 128i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v10() {
        let value = 16384i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v10", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v11() {
        let value = 1_000_000i32;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v11", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v12() {
        let value = i32::MAX;
        assert_codegen_rvsdg_snapshot("json", "scalar_i32__v12", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v0() {
        let value = i64::MIN;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v1() {
        let value = -1_000_000_000_000i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v2() {
        let value = -16384i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v3() {
        let value = -129i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v4() {
        let value = -128i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v5() {
        let value = -1i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v6() {
        let value = 0i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v7() {
        let value = 1i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v8() {
        let value = 127i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v9() {
        let value = 128i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v10() {
        let value = 16384i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v10", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v11() {
        let value = 1_000_000_000_000i64;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v11", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v12() {
        let value = i64::MAX;
        assert_codegen_rvsdg_snapshot("json", "scalar_i64__v12", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn bool_field() {
        let value = BoolField { value: true };
    ...
    fn rename_field() {
        ...
        assert_codegen_rvsdg_snapshot("json", "rename_field", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn deny_unknown_fields_v0() {
        let value = Strict { x: 10, y: 20 };
    ...
    fn default_field() {
        ...
        assert_codegen_rvsdg_snapshot("json", "default_field", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn transparent_scalar() {
        let value = Wrapper(42);
    ...
    fn shared_inner_type() {
        ...
        assert_codegen_rvsdg_snapshot("json", "shared_inner_type", &kajit::json::KajitJson, &value);
    }
}
mod rvsdg_postcard {
    use super::*;
...
mod ra_mir_json {
    ...
    fn flat_struct() {
        ...
        assert_codegen_ra_mir_snapshot("json", "flat_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn nested_struct() {
        let value = Person {
        ...
        assert_codegen_ra_mir_snapshot("json", "nested_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn deep_struct() {
        let value = Outer {
        ...
        assert_codegen_ra_mir_snapshot("json", "deep_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn all_integers() {
        let value = AllIntegers {
        ...
        assert_codegen_ra_mir_snapshot("json", "all_integers", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn all_scalars() {
        let value = AllScalars {
        ...
        assert_codegen_ra_mir_snapshot("json", "all_scalars", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn bool_true_false() {
        let value = Bools { a: true, b: false };
        assert_codegen_ra_mir_snapshot("json", "bool_true_false", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn integer_boundaries() {
        let value = Boundaries {
    ...
    fn scalar_u16_v0() {
        let value = 0u16;
        assert_codegen_ra_mir_snapshot("json", "scalar_u16__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v1() {
        let value = 1u16;
        assert_codegen_ra_mir_snapshot("json", "scalar_u16__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v2() {
        let value = 127u16;
        assert_codegen_ra_mir_snapshot("json", "scalar_u16__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v3() {
        let value = 128u16;
        assert_codegen_ra_mir_snapshot("json", "scalar_u16__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v4() {
        let value = 255u16;
        assert_codegen_ra_mir_snapshot("json", "scalar_u16__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v5() {
        let value = 16383u16;
        assert_codegen_ra_mir_snapshot("json", "scalar_u16__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v6() {
        let value = 16384u16;
        assert_codegen_ra_mir_snapshot("json", "scalar_u16__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v7() {
        let value = u16::MAX;
        assert_codegen_ra_mir_snapshot("json", "scalar_u16__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v0() {
        let value = 0u32;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v1() {
        let value = 1u32;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v2() {
        let value = 127u32;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v3() {
        let value = 128u32;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v4() {
        let value = 16383u32;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v5() {
        let value = 16384u32;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v6() {
        let value = (1u32 << 21) - 1;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v7() {
        let value = 1u32 << 21;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v8() {
        let value = u32::MAX;
        assert_codegen_ra_mir_snapshot("json", "scalar_u32__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v0() {
        let value = 0u64;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v1() {
        let value = 1u64;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v2() {
        let value = 127u64;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v3() {
        let value = 128u64;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v4() {
        let value = 16383u64;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v5() {
        let value = 16384u64;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v6() {
        let value = (1u64 << 21) - 1;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v7() {
        let value = 1u64 << 21;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v8() {
        let value = u64::MAX;
        assert_codegen_ra_mir_snapshot("json", "scalar_u64__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v0() {
        let value = i16::MIN;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v1() {
        let value = -16384i16;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v2() {
        let value = -129i16;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v3() {
        let value = -128i16;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v4() {
        let value = -1i16;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v5() {
        let value = 0i16;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v6() {
        let value = 1i16;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v7() {
        let value = 127i16;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v8() {
        let value = 128i16;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v9() {
        let value = i16::MAX;
        assert_codegen_ra_mir_snapshot("json", "scalar_i16__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v0() {
        let value = i32::MIN;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v1() {
        let value = -1_000_000i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v2() {
        let value = -16384i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v3() {
        let value = -129i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v4() {
        let value = -128i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v5() {
        let value = -1i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v6() {
        let value = 0i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v7() {
        let value = 1i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v8() {
        let value = 127i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v9() {
        let value = 128i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v10() {
        let value = 16384i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v10", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v11() {
        let value = 1_000_000i32;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v11", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v12() {
        let value = i32::MAX;
        assert_codegen_ra_mir_snapshot("json", "scalar_i32__v12", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v0() {
        let value = i64::MIN;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v1() {
        let value = -1_000_000_000_000i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v2() {
        let value = -16384i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v3() {
        let value = -129i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v4() {
        let value = -128i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v5() {
        let value = -1i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v6() {
        let value = 0i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v7() {
        let value = 1i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v8() {
        let value = 127i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v9() {
        let value = 128i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v10() {
        let value = 16384i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v10", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v11() {
        let value = 1_000_000_000_000i64;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v11", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v12() {
        let value = i64::MAX;
        assert_codegen_ra_mir_snapshot("json", "scalar_i64__v12", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn bool_field() {
        let value = BoolField { value: true };
    ...
    fn rename_field() {
        ...
        assert_codegen_ra_mir_snapshot("json", "rename_field", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn deny_unknown_fields_v0() {
        let value = Strict { x: 10, y: 20 };
    ...
    fn default_field() {
        ...
        assert_codegen_ra_mir_snapshot("json", "default_field", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn transparent_scalar() {
        let value = Wrapper(42);
...
mod postreg_edits_json {
    ...
    fn flat_struct() {
        ...
        assert_codegen_edits_snapshot("json", "flat_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn nested_struct() {
        let value = Person {
        ...
        assert_codegen_edits_snapshot("json", "nested_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn deep_struct() {
        let value = Outer {
        ...
        assert_codegen_edits_snapshot("json", "deep_struct", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn all_integers() {
        let value = AllIntegers {
        ...
        assert_codegen_edits_snapshot("json", "all_integers", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn all_scalars() {
        let value = AllScalars {
        ...
        assert_codegen_edits_snapshot("json", "all_scalars", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn bool_true_false() {
        let value = Bools { a: true, b: false };
        assert_codegen_edits_snapshot("json", "bool_true_false", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn integer_boundaries() {
        let value = Boundaries {
    ...
    fn scalar_u16_v0() {
        let value = 0u16;
        assert_codegen_edits_snapshot("json", "scalar_u16__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v1() {
        let value = 1u16;
        assert_codegen_edits_snapshot("json", "scalar_u16__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v2() {
        let value = 127u16;
        assert_codegen_edits_snapshot("json", "scalar_u16__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v3() {
        let value = 128u16;
        assert_codegen_edits_snapshot("json", "scalar_u16__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v4() {
        let value = 255u16;
        assert_codegen_edits_snapshot("json", "scalar_u16__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v5() {
        let value = 16383u16;
        assert_codegen_edits_snapshot("json", "scalar_u16__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v6() {
        let value = 16384u16;
        assert_codegen_edits_snapshot("json", "scalar_u16__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u16_v7() {
        let value = u16::MAX;
        assert_codegen_edits_snapshot("json", "scalar_u16__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v0() {
        let value = 0u32;
        assert_codegen_edits_snapshot("json", "scalar_u32__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v1() {
        let value = 1u32;
        assert_codegen_edits_snapshot("json", "scalar_u32__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v2() {
        let value = 127u32;
        assert_codegen_edits_snapshot("json", "scalar_u32__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v3() {
        let value = 128u32;
        assert_codegen_edits_snapshot("json", "scalar_u32__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v4() {
        let value = 16383u32;
        assert_codegen_edits_snapshot("json", "scalar_u32__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v5() {
        let value = 16384u32;
        assert_codegen_edits_snapshot("json", "scalar_u32__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v6() {
        let value = (1u32 << 21) - 1;
        assert_codegen_edits_snapshot("json", "scalar_u32__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v7() {
        let value = 1u32 << 21;
        assert_codegen_edits_snapshot("json", "scalar_u32__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u32_v8() {
        let value = u32::MAX;
        assert_codegen_edits_snapshot("json", "scalar_u32__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v0() {
        let value = 0u64;
        assert_codegen_edits_snapshot("json", "scalar_u64__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v1() {
        let value = 1u64;
        assert_codegen_edits_snapshot("json", "scalar_u64__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v2() {
        let value = 127u64;
        assert_codegen_edits_snapshot("json", "scalar_u64__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v3() {
        let value = 128u64;
        assert_codegen_edits_snapshot("json", "scalar_u64__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v4() {
        let value = 16383u64;
        assert_codegen_edits_snapshot("json", "scalar_u64__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v5() {
        let value = 16384u64;
        assert_codegen_edits_snapshot("json", "scalar_u64__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v6() {
        let value = (1u64 << 21) - 1;
        assert_codegen_edits_snapshot("json", "scalar_u64__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v7() {
        let value = 1u64 << 21;
        assert_codegen_edits_snapshot("json", "scalar_u64__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_u64_v8() {
        let value = u64::MAX;
        assert_codegen_edits_snapshot("json", "scalar_u64__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v0() {
        let value = i16::MIN;
        assert_codegen_edits_snapshot("json", "scalar_i16__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v1() {
        let value = -16384i16;
        assert_codegen_edits_snapshot("json", "scalar_i16__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v2() {
        let value = -129i16;
        assert_codegen_edits_snapshot("json", "scalar_i16__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v3() {
        let value = -128i16;
        assert_codegen_edits_snapshot("json", "scalar_i16__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v4() {
        let value = -1i16;
        assert_codegen_edits_snapshot("json", "scalar_i16__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v5() {
        let value = 0i16;
        assert_codegen_edits_snapshot("json", "scalar_i16__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v6() {
        let value = 1i16;
        assert_codegen_edits_snapshot("json", "scalar_i16__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v7() {
        let value = 127i16;
        assert_codegen_edits_snapshot("json", "scalar_i16__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v8() {
        let value = 128i16;
        assert_codegen_edits_snapshot("json", "scalar_i16__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i16_v9() {
        let value = i16::MAX;
        assert_codegen_edits_snapshot("json", "scalar_i16__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v0() {
        let value = i32::MIN;
        assert_codegen_edits_snapshot("json", "scalar_i32__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v1() {
        let value = -1_000_000i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v2() {
        let value = -16384i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v3() {
        let value = -129i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v4() {
        let value = -128i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v5() {
        let value = -1i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v6() {
        let value = 0i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v7() {
        let value = 1i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v8() {
        let value = 127i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v9() {
        let value = 128i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v10() {
        let value = 16384i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v10", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v11() {
        let value = 1_000_000i32;
        assert_codegen_edits_snapshot("json", "scalar_i32__v11", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i32_v12() {
        let value = i32::MAX;
        assert_codegen_edits_snapshot("json", "scalar_i32__v12", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v0() {
        let value = i64::MIN;
        assert_codegen_edits_snapshot("json", "scalar_i64__v0", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v1() {
        let value = -1_000_000_000_000i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v1", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v2() {
        let value = -16384i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v2", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v3() {
        let value = -129i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v3", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v4() {
        let value = -128i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v4", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v5() {
        let value = -1i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v5", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v6() {
        let value = 0i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v6", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v7() {
        let value = 1i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v7", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v8() {
        let value = 127i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v8", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v9() {
        let value = 128i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v9", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v10() {
        let value = 16384i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v10", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v11() {
        let value = 1_000_000_000_000i64;
        assert_codegen_edits_snapshot("json", "scalar_i64__v11", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn scalar_i64_v12() {
        let value = i64::MAX;
        assert_codegen_edits_snapshot("json", "scalar_i64__v12", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn bool_field() {
        let value = BoolField { value: true };
    ...
    fn rename_field() {
        ...
        assert_codegen_edits_snapshot("json", "rename_field", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn deny_unknown_fields_v0() {
        let value = Strict { x: 10, y: 20 };
    ...
    fn default_field() {
        ...
        assert_codegen_edits_snapshot("json", "default_field", &kajit::json::KajitJson, &value);
    }
    #[test]
    fn transparent_scalar() {
        let value = Wrapper(42);
    ...
    fn shared_inner_type() {
        ...
        assert_codegen_edits_snapshot("json", "shared_inner_type", &kajit::json::KajitJson, &value);
    }
}
