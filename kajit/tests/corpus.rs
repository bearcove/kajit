    ...
    for<'input> T: Facet<'input>,
{
    ...
    let (reduced, stats, interestingness) = kajit_mir::minimize_cfg_program_for_differential(
            &program,
            input,
        )
        .unwrap_or_else(|err| {
    ...
    eprintln!(
        ...
        stats.initial_size.blocks, stats.final_size.blocks, stats.initial_size.insts,
        stats.final_size.insts, stats.initial_size.edges, stats.final_size.edges, stats
        .accepted, stats.attempts
    );
    eprintln!(
        "preserved differential signature: field={}, ideal_trap={:?}, post_trap={:?}, ideal_returned={}, post_returned={}",
        interestingness.field, interestingness.ideal_trap, interestingness.post_trap,
        interestingness.ideal_returned, interestingness.post_returned
    );
