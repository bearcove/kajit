...
use facet::{
    Def, EnumRepr, KnownPointer, ListDef, MapDef, OptionDef, PointerDef, ScalarType, Shape,
    StructKind, Type, UserType,
};

use crate::arch::EmitCtx;
use crate::format::{
    Decoder, Encoder, FieldEmitInfo, FieldEncodeInfo, FieldLowerInfo, SkippedFieldInfo,
