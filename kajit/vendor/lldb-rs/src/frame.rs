...
use crate::{
    SBAddress, SBBlock, SBCompileUnit, SBExpressionOptions, SBFunction, SBLineEntry, SBModule,
    SBStream, SBSymbol, SBSymbolContext, SBThread, SBValue, SBValueList, SBVariablesOptions,
    lldb_addr_t, sys,
};
...
impl SBFrame {
    ...
    pub fn cfa(&self) -> Option<lldb_addr_t> {
        ...
        if cfa != u64::MAX { Some(cfa) } else { None }
    }
